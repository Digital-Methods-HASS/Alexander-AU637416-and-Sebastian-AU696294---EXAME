...
# Load the kings - Make sure to first create an .Rproj workspace with a data/ folder where you place either your own dataset or the provided kings.csv dataset.
